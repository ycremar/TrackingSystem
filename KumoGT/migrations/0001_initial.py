# Generated by Django 2.2.6 on 2019-11-24 05:47
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deg_type', models.CharField(choices=[('phd', 'PhDCS'), ('ms_thesis', 'MSCS(Thesis)'), ('ms_non_thesis', 'MSCS(Non-Thesis)'), ('meng', 'MEngCS')], default='none', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ethnicity', models.CharField(choices=[('not sel', 'Not Selected'), ('his_or_la', 'Hispanic or Latino'), ('not_his_or_la', 'Not Hispanic or Latino')], default='not sel', max_length=255)),
                ('status', models.CharField(choices=[('current', 'Current'), ('graduated', 'Gradudated'), ('invalid', 'Invalid')], default='current', max_length=255)),
